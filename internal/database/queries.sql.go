...
const getImageIDByFilenameStem = `-- name: GetImageIDByFilenameStem :one
...
func (q *Queries) GetImageIDByFilenameStem(ctx context.Context, lower string) (string, error) {
	row := q.db.QueryRowContext(ctx, getImageIDByFilenameStem, lower)
	var id string
	err := row.Scan(&id)
	return id, err
}
